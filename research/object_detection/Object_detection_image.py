...
IMAGE_NAME = '/home/mi/road_sign_detection/Data/test/pedestrian/FILE190902-104316F.MP4.thumb0048.jpg'
...
with detection_graph.as_default():
    ...
    gpu_op = tf.GPUOptions(per_process_gpu_memory_fraction=0.90)
...
for j in range(nprehit):
    ...
    if(score)>=0.1:
        ...
        with open(IMAGE_NAME+ '.json', 'w') as outputFile:
