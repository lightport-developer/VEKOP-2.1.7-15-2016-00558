...
def class_text_to_int(row_label):
    if row_label == 'speed_limit_40':
        return 1
    if row_label == 'speed_limit_60':
        return 2
    if row_label == 'speed_limit_70':
        return 3
    if row_label == 'no_overtaking':
        return 4
    if row_label == 'no_parking':
        return 5
    if row_label == 'pedestrian_crossing':
        return 6
    if row_label == 'priority_road':
        return 7
